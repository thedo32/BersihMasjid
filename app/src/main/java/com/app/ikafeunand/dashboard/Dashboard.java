package com.app.ikafeunand.dashboard;
...
import com.app.ikafeunand.AdapterDiary;
import com.app.ikafeunand.SignInActivity;
import com.app.ikafeunand.databinding.ActivityDashboardBinding;
...
public class Dashboard extends AppCompatActivity implements UpdateDiary {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        admin = "qo0QKUuNSkVCZleE2qKG2mYC0bR2";
    ...
    private void showDiary(){
        ...
        referenceusr.child(unique).child("bname").get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
            @Override
        ...
        referenceusr.child(unique).child("apoint").get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
